...
@pytest.mark.asyncio
async def test_get_warn_static(dikong_config) -> None:
...
@pytest.mark.asyncio
async def test_get_media_static(dikong_config) -> None:
...
@pytest.mark.asyncio
async def test_get_hms_stats(dikong_config) -> None:
...
@pytest.mark.asyncio
async def test_query_missions_by_page(dikong_config) -> None:
    body = {
        "code": 0,
        "data": {
            "total": 2,
